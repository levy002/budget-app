class TransactionsController < ApplicationController
  ...
  def destroy
    ...
    if @transaction.destroy!
      redirect_to category_url(@transaction.category), notice: "Transaction was successfully deleted."
    else
      redirect_to category_url(@transaction.category), notice: "Faile to delete transaction."
    end
  end
